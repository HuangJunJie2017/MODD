...
for iou_threshold = 0.7%0.3:0.1:0.7;
...
% text(successrate_final(1),precision_final(1),sprintf('  iou=%01.1f',iou_threshold));
hold off
figure(2)
hold on
plot(false_positive_final,successrate_final,'color','r','LineWidth',1.5);
% text(false_positive_final(1),successrate_final(1),sprintf('  iou=%01.1f',iou_threshold));
% axis([0 1 0 1])
end
figure(1)
hold on
